...
enum OperationType{
    NONE_OPER, TOPLEFT_OPER, TOPRIGHT_OPER, BOTTOMLEFT_OPER, BOTTOMRIGHT_OPER, CONTAINS_OPER, OUTSIDE_OPER,
    LEFT_OPER, RIGHT_OPER, TOP_OPER, BOTTOM_OPER
};

class ScreenShot : public QWidget{
    Q_OBJECT
public:
    explicit ScreenShot(QString* name, QWidget *parent = nullptr);
private:
