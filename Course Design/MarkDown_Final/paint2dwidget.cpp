...
Paint2DWidget::Paint2DWidget(QString backgroundFileName, QWidget *parent) :
    QWidget(parent){
    curId = 0;
    curMode = NONE;
    ...
    if(backgroundFileName != ""){
        ...
        backgroundImage = new QImage(backgroundFileName);
//        this->setAutoFillBackground(true);
//        QPalette palette = this->palette();
//        palette.setBrush(QPalette::Window,QBrush(QPixmap(backgroundFileName)));// 使用平滑的缩放方式
...
void Paint2DWidget::saveTo(QString fileName, const char* format){
    ...
    if(backgroundImage == nullptr){
        ...
        image = new QImage(*backgroundImage);
    }
...
void Paint2DWidget::paintEvent(QPaintEvent*){
    ...
    if(backgroundName != ""){
        painter.drawPixmap(backgroundImage->rect(), QPixmap(backgroundName), QRect());
    }
