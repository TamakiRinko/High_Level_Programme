#ifndef PAINT2DWINDOW_H
#define PAINT2DWINDOW_H
...
public:
    explicit Paint2DWidget(QString backgroundFileName = "", QWidget *parent = nullptr);
    ...
    void withDraw();                            //撤回
    void reDraw();                              //重画
    void saveTo(QString fileName, const char* format = "jpg");            //保存为指定格式
    void graphicsCopy();
    void graphicsPaste();
    void reset();
